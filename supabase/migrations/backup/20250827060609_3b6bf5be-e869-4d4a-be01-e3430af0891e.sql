-- Update projects table according to specification
...
-- Create new status enum for project lifecycle status (drop first if exists)
DROP TYPE IF EXISTS project_lifecycle_status;
