-- Migration: Fix dashboard summary function final
-- Date: 2025-01-28
-- Description: Final fix for the dashboard function table alias issue

-- Drop the existing function
DROP FUNCTION IF EXISTS public.get_dashboard_summary();

-- Recreate the dashboard summary function with correct table references
