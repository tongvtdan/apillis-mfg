-- Fix Dashboard Summary Function for Priority Level Enum
-- This migration updates the dashboard summary function to handle projects with NULL priority_level correctly
