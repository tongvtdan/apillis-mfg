-- Factory Pulse Database Seed File - Step 1: Organizations
...
-- Step 4: Workflow Stages and Projects
-- Creating workflow stages first, then projects
...
-- Projects
INSERT INTO projects (id, organization_id, project_id, title, description, customer_id, current_stage_id, status, priority_level, source, assigned_to, created_by, estimated_value, project_type) VALUES 
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), 'P-25012701', 'Automotive Bracket Assembly', 'High-precision automotive bracket assembly for Toyota Vietnam', (SELECT id FROM contacts WHERE email = 'procurement@toyota.vn' LIMIT 1), (SELECT id FROM workflow_stages WHERE name = 'Inquiry Received' LIMIT 1), 'active', 'high', 'portal', (SELECT id FROM users WHERE email = 'procurement2@factorypulse.vn' LIMIT 1), (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), 50000.00, 'fabrication'),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), 'P-25012702', 'Motorcycle Frame Welding', 'Motorcycle frame welding project for Honda Vietnam', (SELECT id FROM contacts WHERE email = 'purchasing@honda.vn' LIMIT 1), (SELECT id FROM workflow_stages WHERE name = 'Technical Review' LIMIT 1), 'active', 'medium', 'portal', (SELECT id FROM users WHERE email = 'production@factorypulse.vn' LIMIT 1), (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), 35000.00, 'welding'),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), 'P-25012703', 'Aircraft Landing Gear Bracket', 'High-precision aircraft landing gear bracket for Boeing Vietnam', (SELECT id FROM contacts WHERE email = 'supply.chain@boeing.vn' LIMIT 1), (SELECT id FROM workflow_stages WHERE name = 'Supplier RFQ' LIMIT 1), 'active', 'urgent', 'portal', (SELECT id FROM users WHERE email = 'engineering@factorypulse.vn' LIMIT 1), (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), 120000.00, 'aerospace'),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), 'P-25012704', 'Electronics Manufacturing Batch', 'Electronics manufacturing batch for Samsung Vietnam', (SELECT id FROM contacts WHERE email = 'procurement@samsung.vn' LIMIT 1), (SELECT id FROM workflow_stages WHERE name = 'Quoted' LIMIT 1), 'active', 'high', 'portal', (SELECT id FROM users WHERE email = 'qa@factorypulse.vn' LIMIT 1), (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), 75000.00, 'electronics'),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), 'P-25012705', 'Industrial Automation Panel', 'Industrial automation control panel for Siemens Vietnam', (SELECT id FROM contacts WHERE email = 'procurement@siemens.vn' LIMIT 1), (SELECT id FROM workflow_stages WHERE name = 'Order Confirmed' LIMIT 1), 'active', 'medium', 'portal', (SELECT id FROM users WHERE email = 'engineering2@factorypulse.vn' LIMIT 1), (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), 45000.00, 'automation'),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), 'P-25012706', 'Home Appliance Components', 'Home appliance components for LG Vietnam', (SELECT id FROM contacts WHERE email = 'purchasing@lg.vn' LIMIT 1), (SELECT id FROM workflow_stages WHERE name = 'Procurement Planning' LIMIT 1), 'active', 'low', 'portal', (SELECT id FROM users WHERE email = 'production2@factorypulse.vn' LIMIT 1), (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), 28000.00, 'appliance'),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), 'P-25012707', 'Aerospace Engine Parts', 'Aerospace engine components for Airbus Vietnam', (SELECT id FROM contacts WHERE email = 'supply.chain@airbus.vn' LIMIT 1), (SELECT id FROM workflow_stages WHERE name = 'In Production' LIMIT 1), 'active', 'urgent', 'portal', (SELECT id FROM users WHERE email = 'engineering@factorypulse.vn' LIMIT 1), (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), 150000.00, 'aerospace'),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), 'P-25012708', 'Power System Components', 'Power system components for ABB Vietnam', (SELECT id FROM contacts WHERE email = 'procurement@abb.vn' LIMIT 1), (SELECT id FROM workflow_stages WHERE name = 'Shipped & Closed' LIMIT 1), 'active', 'high', 'portal', (SELECT id FROM users WHERE email = 'engineering2@factorypulse.vn' LIMIT 1), (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), 85000.00, 'power_systems');

-- Step 5: Additional Supporting Data
-- Project Assignments, Documents, Reviews, Messages, Notifications, and Activity Log

-- Project Assignments
INSERT INTO project_assignments (id, project_id, user_id, role, assigned_at, is_active) VALUES 
(uuid_generate_v4(), (SELECT id FROM projects WHERE project_id = 'P-25012701' LIMIT 1), (SELECT id FROM users WHERE email = 'procurement2@factorypulse.vn' LIMIT 1), 'Project Manager', NOW(), true),
(uuid_generate_v4(), (SELECT id FROM projects WHERE project_id = 'P-25012702' LIMIT 1), (SELECT id FROM users WHERE email = 'production@factorypulse.vn' LIMIT 1), 'Production Lead', NOW(), true),
(uuid_generate_v4(), (SELECT id FROM projects WHERE project_id = 'P-25012703' LIMIT 1), (SELECT id FROM users WHERE email = 'engineering@factorypulse.vn' LIMIT 1), 'Engineering Lead', NOW(), true),
(uuid_generate_v4(), (SELECT id FROM projects WHERE project_id = 'P-25012704' LIMIT 1), (SELECT id FROM users WHERE email = 'qa@factorypulse.vn' LIMIT 1), 'Quality Lead', NOW(), true),
(uuid_generate_v4(), (SELECT id FROM projects WHERE project_id = 'P-25012705' LIMIT 1), (SELECT id FROM users WHERE email = 'engineering2@factorypulse.vn' LIMIT 1), 'Technical Lead', NOW(), true);

-- Documents
INSERT INTO documents (id, organization_id, project_id, file_name, original_file_name, file_url, file_size, mime_type, document_type, uploaded_by, is_active) VALUES 
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM projects WHERE project_id = 'P-25012701' LIMIT 1), 'toyota_bracket_spec.pdf', 'Toyota Bracket Specification.pdf', 'https://storage.factorypulse.vn/documents/toyota_bracket_spec.pdf', 2048576, 'application/pdf', 'specification', (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), true),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM projects WHERE project_id = 'P-25012702' LIMIT 1), 'honda_frame_drawing.dwg', 'Honda Frame Drawing.dwg', 'https://storage.factorypulse.vn/documents/honda_frame_drawing.dwg', 1048576, 'application/acad', 'technical_drawing', (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), true),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM projects WHERE project_id = 'P-25012703' LIMIT 1), 'boeing_landing_gear_spec.pdf', 'Boeing Landing Gear Specification.pdf', 'https://storage.factorypulse.vn/documents/boeing_landing_gear_spec.pdf', 3145728, 'application/pdf', 'specification', (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), true);

-- Reviews
INSERT INTO reviews (id, organization_id, project_id, reviewer_id, reviewer_role, review_type, status, reviewed_at, risks, recommendations, tooling_required, estimated_cost, estimated_lead_time, notes) VALUES 
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM projects WHERE project_id = 'P-25012701' LIMIT 1), (SELECT id FROM users WHERE email = 'engineering@factorypulse.vn' LIMIT 1), 'Engineering Manager', 'technical', 'approved', NOW(), ARRAY['Material availability', 'Tolerance requirements'], ARRAY['Use CNC machining', 'Implement quality checks'], ARRAY['CNC machine', 'Measuring tools'], 50000.00, 30, 'Project approved for production'),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM projects WHERE project_id = 'P-25012702' LIMIT 1), (SELECT id FROM users WHERE email = 'qa@factorypulse.vn' LIMIT 1), 'QA Manager', 'quality', 'approved', NOW(), ARRAY['Welding quality', 'Safety standards'], ARRAY['Implement welding procedures', 'Safety training required'], ARRAY['Welding equipment', 'Safety gear'], 35000.00, 30, 'Quality standards met');

-- Messages
INSERT INTO messages (id, organization_id, project_id, thread_id, sender_type, sender_user_id, recipient_type, recipient_user_id, subject, content, is_read) VALUES 
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM projects WHERE project_id = 'P-25012701' LIMIT 1), (SELECT id FROM projects WHERE project_id = 'P-25012701' LIMIT 1), 'user', (SELECT id FROM users WHERE email = 'procurement2@factorypulse.vn' LIMIT 1), 'user', (SELECT id FROM users WHERE email = 'engineering@factorypulse.vn' LIMIT 1), 'Project Kickoff Meeting', 'Hi Engineering team, we have a new project for Toyota Vietnam. Can we schedule a kickoff meeting this week?', false),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM projects WHERE project_id = 'P-25012702' LIMIT 1), (SELECT id FROM projects WHERE project_id = 'P-25012702' LIMIT 1), 'user', (SELECT id FROM users WHERE email = 'production@factorypulse.vn' LIMIT 1), 'user', (SELECT id FROM users WHERE email = 'qa@factorypulse.vn' LIMIT 1), 'Quality Review Required', 'Production team has completed the Honda frame welding. QA review needed before shipping.', false);

-- Notifications
INSERT INTO notifications (id, organization_id, user_id, title, message, type, link, is_read, delivered_at) VALUES 
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM users WHERE email = 'procurement2@factorypulse.vn' LIMIT 1), 'New Project Assignment', 'You have been assigned to manage the Toyota Bracket Assembly project', 'info', '/projects/P-25012701', false, NOW()),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM users WHERE email = 'engineering@factorypulse.vn' LIMIT 1), 'Engineering Review Required', 'New project requires engineering review and approval', 'warning', '/projects/P-25012701', false, NOW()),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM users WHERE email = 'qa@factorypulse.vn' LIMIT 1), 'Quality Review Pending', 'Honda frame welding project ready for quality review', 'info', '/projects/P-25012702', false, NOW());

-- Activity Log
INSERT INTO activity_log (id, organization_id, user_id, action, entity_type, entity_id, old_values, new_values, ip_address, session_id) VALUES 
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM users WHERE email = 'qa2@factorypulse.vn' LIMIT 1), 'project_created', 'projects', (SELECT id FROM projects WHERE project_id = 'P-25012701' LIMIT 1), '{}', '{"title": "Automotive Bracket Assembly", "customer_id": "Toyota Vietnam"}', '127.0.0.1', 'session_001'),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM users WHERE email = 'engineering@factorypulse.vn' LIMIT 1), 'review_approved', 'reviews', (SELECT id FROM reviews WHERE reviewer_id = (SELECT id FROM users WHERE email = 'engineering@factorypulse.vn' LIMIT 1) LIMIT 1), '{"status": "pending"}', '{"status": "approved"}', '127.0.0.1', 'session_002'),
(uuid_generate_v4(), (SELECT id FROM organizations WHERE slug = 'factory-pulse-vietnam' LIMIT 1), (SELECT id FROM users WHERE email = 'procurement2@factorypulse.vn' LIMIT 1), 'project_assigned', 'project_assignments', (SELECT id FROM project_assignments WHERE user_id = (SELECT id FROM users WHERE email = 'procurement2@factorypulse.vn' LIMIT 1) LIMIT 1), '{}', '{"role": "Project Manager", "user_id": "procurement2@factorypulse.vn"}', '127.0.0.1', 'session_003');
