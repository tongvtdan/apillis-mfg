...
BEGIN
    ...
    INSERT INTO workflow_stages (
        ...
        (org_id, 'Inquiry Received', 'inquiry_received', 'Initial inquiry received from customer', 1, 1, ARRAY['admin', 'sales'], true, NOW(), NOW()),
    ...
    INSERT INTO workflow_sub_stages (
        ...
        (org_id, stage_id_inquiry, 'Initial Contact', 'initial_contact', 'Initial customer contact recorded', 1, true, true, false, false, 2, ARRAY['admin'], NOW(), NOW()),
        (org_id, stage_id_inquiry, 'Requirement Gathering', 'requirement_gathering', 'Gather project requirements', 2, true, true, false, false, 4, ARRAY['admin', 'sales'], NOW(), NOW()),
        (org_id, stage_id_inquiry, 'Feasibility Check', 'feasibility_check', 'Check technical feasibility', 3, true, false, true, false, 2, ARRAY['admin', 'engineering'], NOW(), NOW())
    ON CONFLICT (organization_id, slug) DO NOTHING;
    ...
    INSERT INTO workflow_sub_stages (
        ...
        (org_id, stage_id_technical, 'Design Review', 'design_review', 'Review design requirements', 1, true, true, false, false, 8, ARRAY['admin', 'engineering'], NOW(), NOW()),
        (org_id, stage_id_technical, 'Material Analysis', 'material_analysis', 'Analyze material requirements', 2, true, true, false, false, 6, ARRAY['admin', 'engineering'], NOW(), NOW()),
        (org_id, stage_id_technical, 'Cost Estimation', 'cost_estimation', 'Estimate project costs', 3, true, true, false, false, 4, ARRAY['admin', 'engineering'], NOW(), NOW())
    ON CONFLICT (organization_id, slug) DO NOTHING;
    ...
    INSERT INTO workflow_sub_stages (
        ...
        (org_id, stage_id_supplier, 'Supplier Selection', 'supplier_selection', 'Select appropriate suppliers', 1, true, true, false, false, 4, ARRAY['admin', 'procurement'], NOW(), NOW()),
        (org_id, stage_id_supplier, 'RFQ Preparation', 'rfq_preparation', 'Prepare RFQ documents', 2, true, true, false, false, 8, ARRAY['admin', 'procurement'], NOW(), NOW()),
        (org_id, stage_id_supplier, 'RFQ Distribution', 'rfq_distribution', 'Send RFQ to suppliers', 3, true, true, false, false, 2, ARRAY['admin', 'procurement'], NOW(), NOW())
    ON CONFLICT (organization_id, slug) DO NOTHING;
    ...
    INSERT INTO workflow_sub_stages (
        ...
        (org_id, stage_id_procurement, 'Material Procurement', 'material_procurement', 'Procure required materials', 1, true, true, false, false, 16, ARRAY['admin', 'procurement'], NOW(), NOW()),
        (org_id, stage_id_procurement, 'Quality Check', 'quality_check', 'Quality assurance check', 2, true, true, false, false, 8, ARRAY['admin', 'procurement'], NOW(), NOW()),
        (org_id, stage_id_procurement, 'Inventory Management', 'inventory_management', 'Manage inventory', 3, true, true, false, false, 4, ARRAY['admin', 'procurement'], NOW(), NOW())
    ON CONFLICT (organization_id, slug) DO NOTHING;
    ...
    INSERT INTO workflow_sub_stages (
        ...
        (org_id, stage_id_production, 'Setup', 'setup', 'Production setup and preparation', 1, true, true, false, false, 8, ARRAY['admin', 'production'], NOW(), NOW()),
        (org_id, stage_id_production, 'Manufacturing', 'manufacturing', 'Main manufacturing process', 2, true, true, false, false, 48, ARRAY['admin', 'production'], NOW(), NOW()),
        (org_id, stage_id_production, 'Quality Control', 'quality_control', 'Final quality control', 3, true, true, false, false, 8, ARRAY['admin', 'production'], NOW(), NOW()),
        (org_id, stage_id_production, 'Packaging', 'packaging', 'Product packaging', 4, true, true, false, false, 4, ARRAY['admin', 'production'], NOW(), NOW())
    ON CONFLICT (organization_id, slug) DO NOTHING;
