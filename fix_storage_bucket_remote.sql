-- =========================================
-- Fix Storage Bucket for Remote Supabase
-- =========================================
-- This script creates the 'documents' storage bucket needed for file uploads
-- Run this in your Supabase SQL Editor on the remote instance
...
SELECT 'Storage bucket setup completed for remote Supabase' as status;
